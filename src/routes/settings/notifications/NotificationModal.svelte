...
jsons://hostname/webhook/path"
					...
					<p class="text-xs text-muted-foreground">
						支持 Gotify (gotify://，HTTPS 请使用 gotifys://), Discord, Slack, Mattermost (mmost://，HTTPS 请使用 mmosts://), Telegram, ntfy, Bark, Pushover, Workflows (如 Microsoft Teams) 以及通用 JSON Webhook。
						</p>
					</div>
				</div>
			{/if}
