		...
		<div class="flex items-start gap-2">
			...
			<div class="space-y-2 text-xs">
				{#if systemContainer === 'dockhand'}
					<p class="font-medium text-blue-600 dark:text-blue-400">暂不支持定时自动更新</p>
					<p class="text-muted-foreground">
						Dockhand 不会按照计划自动更新。发布新版本后，请前往<a href="/settings?tab=about" class="text-primary hover:underline">设置 &gt; 关于</a>进行更新。
					</p>
				{:else}
